  ...
  <div class="sidebar">
    <div class="logo-details">
      ...
      <ul class="nav-links">
        ...
        <li>
          <a href="approver_gatepass.php" class="active">
...
$ret=mysqli_query($conn,"SELECT * from gatepass where reqStatus = 'Pending'");
      ...
      while ($row=mysqli_fetch_array($ret)) {
        ?>
            ...
            <td data-label="GATEPASS REQUEST FILE"><i class='bx bxs-file-pdf' ></i><a href="../includes/gp.php?controlNo=<?php echo $row['id'];?>" target="_blank"><?php echo "Gatepass#".$row['id']."_".$row['requestedBy']."_".$row['dateRequested'];?></a></td>

  ...
  <section class="home-section">
    <nav class="nav_menu">
      <div class="sidebar-button">
        ...
        <span class="dashboard">Travel Order Request</span>
      </div>
    ...
    <div class="home-content">
      <div class="table">
        ...
        <div class="twelve">
          <h4>List of TOD & RD approved Travel Request</h4>
        </div>
...
$ret=mysqli_query($conn,"SELECT * from travelorder where reqStatus2 = 'Approved'");
      ...
      while ($row=mysqli_fetch_array($ret)) {
        ?>
            ...
            <td data-label="DATE OF TRAVEL"><?php echo $row['inclusiveDate'];?></td>
            <td data-label="DESTINATION"><?php echo $row['destination'];?></td>
            <td data-label="TRAVEL REQUEST FILE"><i class='bx bxs-file-pdf' ></i><a href="../includes/downloadRDsigned.php?controlNo=<?php echo $row['controlNo'];?>" target="_blank"><?php echo "Travel Order#".$row['controlNo']."_".$row['requestedBy']."_".$row['dateRequested'];?></a></td>

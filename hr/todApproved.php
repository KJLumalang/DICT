  ...
  <section class="home-section">
    ...
    <div class="home-content">
      <div class="table">
        ...
        <div class="twelve">
          <h4>List of TOD approved Travel Request</h4>
        </div>
...
$ret=mysqli_query($conn,"SELECT * from travelorder where reqStatus = 'Approved'");
      ...
      while ($row=mysqli_fetch_array($ret)) {
        ?>
            ...
            <td data-label="TRAVEL REQUEST FILE"><i class='bx bxs-file-pdf' ></i><a href="../includes/download.php?controlNo=<?php echo $row['controlNo'];?>" target="_blank"><?php echo "Travel Order#".$row['controlNo']."_".$row['requestedBy']."_".$row['dateRequested'];?></a></td>
